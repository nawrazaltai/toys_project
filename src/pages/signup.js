          ...
          <section className={styles.section}>
            <div className={styles.logo}>
              ...
              <p className={styles.textP}>
                ...
                for others to browse. You can also search for toys that you may
                be interested in for your own children. Our platform is easy to
                use and we encourage you to browse often, as new toys are added
                daily.
              </p>
            </div>
            <div>
